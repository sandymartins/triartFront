  ...
  return (
    ...
    <Container maxWidth="sm" className='container-form'>
      <form onSubmit={onSubmit} className='formLetter'>
          ...
          <TextField value={produtos.foto} onChange={(event: ChangeEvent<HTMLInputElement>) => updatedProduto(event)} id="foto" label="Foto (Url)" name="foto" variant="outlined" margin="normal" fullWidth />
